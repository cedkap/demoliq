 ...
 * @UniqueEntity(fields={"Nom"}, message="Déjà utilisé desolé !")
 * @UniqueEntity(fields={"socialSecurityNumber"}, message="Déjà utilisé desolé !")
...
class User implements UserInterface
{
    ...
    /**
     * @Assert\NotBlank(message="Email svp")
